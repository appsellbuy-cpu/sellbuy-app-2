...
export const PropertyCard: React.FC<PropertyCardProps> = ({
  ...
  return (
    <div 
      ...
      className="group bg-white rounded-2xl overflow-hidden border border-slate-200/90 hover:border-amber-400 shadow-2xs hover:shadow-md transition-all duration-300 flex flex-col cursor-pointer relative"
    >
      ...
      <div className="p-3 flex-1 flex flex-col justify-between space-y-2.5">
        ...
        <div>
          ...
          {/* Compact Specs Row (BHK, Baths, Area, Furnishing) */}
          ...
          {/* Quick Furnishing & Possession badget tags */}
